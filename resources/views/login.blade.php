      ...
      <div>
        ...
        @csrf
          ...
          <div class="form-group">
            ...
            <a class="tcolor"  href = "{{url('forgotpassword')}}" style="text-decoration: none;">forgot password?</a>
          </div>
          <button type="submit" class=" sub btn btn-default">Submit</button>
        </form>
        <div>
          <a class="tcolor sub btn btn-default"  href = "{{url('createaccount')}}"style="text-decoration: none;">createAccount</a>
        </div>
      </div>
    </div>
  </div>
